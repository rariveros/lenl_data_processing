...
if __name__ == '__main__':
    ...
    #hacer multiples intentos con periodos en la linea del máximo y graficar, el más plano queda (regresión lineal, pendiente más cercana a 0)
    #hacer un gráfico comparativo entre cada toma de datos viendo como cambian los modos
    #hacer gráfico a vs f e identificar puntos con diferentes comportamientos (figuras y colorcitos)
    #lo mismo pero con amplitud versus Gamma(figuras y colorcitos)
    Nx = len(Z_mm[0, :])
